...
if everyone's going all in then maybe i shouldn't1
*/
...
function bot_get_preflop_bet () {
  var num_players_playing_the_hand = internal_setup();
...
//      break;  <-- mistake ?
  ...
  if (HCONF > 99) {
    ...
    if (num_players_playing_the_hand < 4) return internal_what_do_x("2:BIG,15:MED,33:SMALL,50:CALL");
  ...
  if (HCONF > 90) {
    ...
    if (num_players_playing_the_hand > 3) return internal_what_do_x("5:ALLIN,15:BIG,35:MED,35:SMALL,10:CALL");
