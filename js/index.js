...
function new_round () {
  ...
  if (num_playing < 2) {
    gui_setup_fold_call_click("Почати нову гру",
                              0,
                              new_game,
                              new_game);
    return;
  ...
  var message = "<tr><td><font size=+2><b>Новий раунд</b></font>";
...
function deal_flop () {
  ...
  var message = "<tr><td><font size=+2><b>Роздача флопа</b></font>";
  gui_write_game_response(message);
  for (var i = 0; i < 3; i++) {
...
function deal_fourth () {
  ...
  var message = "<tr><td><font size=+2><b>Роздача черги</b></font>";
  gui_write_game_response(message);
...
function deal_fifth () {
  ...
  var message = "<tr><td><font size=+2><b>Роздача рівера</b></font>";
  gui_write_game_response(message);
